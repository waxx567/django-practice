...
A user-friendly CRM project for comprehensive customer data control featuring full CRUD (create, read, update, and delete) capablities, event management and notifications with an easy-to-operate UI.
